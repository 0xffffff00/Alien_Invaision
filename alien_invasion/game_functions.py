...
def fire_bullet(ai_settings, screen, ship, bullets):
	...
	# Releases a bullet if the maximum has not yet been reached.
...
def update_bullets(ai_settings, screen, stats, sb, ship, 
	...
	bullets.update()
		...
		# Delete bullets after click space.
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, 
	...
	# Delete bullet and alien if collision.
	# Check collision.
...
def create_alien(ai_settings, screen, aliens, alien_number, row_number):
	...
	# Create UFO, and place him in a row.
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
	...
	# Updates position all UFO in fleet.
	check_fleet_edges(ai_settings, aliens)
	aliens.update()

	# Check collision "ufo - ship"
